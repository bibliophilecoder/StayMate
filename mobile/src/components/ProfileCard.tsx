...
export function ProfileCard({ profile }: { profile: Profile }) {
  return <View className="overflow-hidden rounded-card border border-indigo-100 bg-white shadow-lg">
    <View className="h-[320px] overflow-hidden bg-[#FFF9F2]">
      ...
      <LinearGradient colors={["transparent", "rgba(82,103,232,0.26)"]} locations={[0.55, 1]} className="absolute inset-0" />
    ...
    <LinearGradient colors={["#FFFFFF", "#F8FAFF", "#EEF1FF"]} locations={[0, 0.58, 1]} className="p-5">
      <View className="flex-row items-start justify-between">
        ...
        <LinearGradient colors={["#ECFFF5", "#DDF9EA"]} className="rounded-2xl border border-green-100 p-3 shadow-sm">
